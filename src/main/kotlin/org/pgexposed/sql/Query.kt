...
open class Query(set: FieldSet, where: Op<Boolean>?): SizedIterable<ResultRow>, Statement<ResultSet>(StatementType.SELECT, set.source.targetTables()) {
     ...
     * @sample org.pgexposed.sql.tests.shared.DMLTests.testAdjustQuerySlice
     */
     ...
     * @sample org.pgexposed.sql.tests.shared.DMLTests.testAdjustQueryColumnSet
     */
     ...
     * @sample org.pgexposed.sql.tests.shared.DMLTests.testAdjustQueryWhere
     */
