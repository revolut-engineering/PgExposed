...
import com.revolut.pgexposed.sql.statements.Statement
import com.revolut.pgexposed.sql.statements.StatementType
...
open class Query(set: FieldSet, where: Op<Boolean>?): SizedIterable<ResultRow>, Statement<ResultSet>(StatementType.SELECT, set.source.targetTables()) {
     ...
     * @sample com.revolut.pgexposed.sql.tests.shared.DMLTests.testAdjustQuerySlice
     */
     ...
     * @sample com.revolut.pgexposed.sql.tests.shared.DMLTests.testAdjustQueryColumnSet
     */
     ...
     * @sample com.revolut.pgexposed.sql.tests.shared.DMLTests.testAdjustQueryWhere
     */
